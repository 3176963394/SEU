...
// Engineer: 
// 
// Create Date: 2024/05/18 20:03:45
// Design Name: 
// Module Name: display
// Project Name: 
// Target Devices: 
...
//        MBR_reg <= MBR_IN;
    case(display_index)
        ...
        begin
            ...
            display_data_reg <= digital_display(ACC_IN[3:0]);
        end
        1:
        begin
            display_control_reg <= 8'b11111101;
            display_data_reg <= digital_display(ACC_IN[7:4]);
        end
        2:
        begin
            display_control_reg=8'b11111011;
            display_data_reg <= digital_display(ACC_IN[11:8]);
        end
        3:
        begin
            display_control_reg=8'b11110111;
            display_data_reg <= digital_display(ACC_IN[15:12]);
        end
        4:
        begin
